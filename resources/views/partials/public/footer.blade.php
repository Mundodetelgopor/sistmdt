    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-5 col-xs-12">
                <ul class="list-inline">
                    <li><img src="{{ asset('frontend/img/home/footer/card1.png') }}"></li>
                    <li><img src="{{ asset('frontend/img/home/footer/card2.png') }}"></li>
                    <li><img src="{{ asset('frontend/img/home/footer/card3.png') }}"></li>
                    <li><img src="{{ asset('frontend/img/home/footer/card4.png') }}"></li>
                </ul>
            </div>
        </div>
    </div>
