@extends('layouts.public_master') @section('content') <!-- HEADER -->
<div class="header clearfix"> <!-- TOPBAR --> @include('partials.public.topbar')
...
<section class="mainContent clearfix">
    <div class="container">
        <!-- PRODUCTS SECTION -->
        <div class="row aboutUsInfo featuredCollection version2">
            <div class="col-xs-12">
